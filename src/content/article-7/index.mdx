...
[Cornell, for example](https://news.cornell.edu/stories/2020/08/robots-know-how-drive-covid-labs-massive-testing-effort)[^3], employs pooled testing to screen 93 samples at a time. With the help of robots to automate the pooling process, the College of Veterinary Medicine tests about 6,000 people a day. Despite this impressive result, we can do better. By creatively splitting and recombining batch samples, thousands of dollars can be saved when testing large populations.
