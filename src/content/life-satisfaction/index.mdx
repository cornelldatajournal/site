...
section: "Health"
image_path: "public/images/SP25/LifeSat/Thumb.webp"
layout: "image"
order: 0
...
It’s estimated that around [10.9%](https://doi.org/10.1007/s11414-019-09670-8) of young adults experience depression, a rate that is higher than any other age group. Young adults are also the most likely age range to use social media, with estimates around [84%](https://www.pewresearch.org/internet/2021/04/07/social-media-use-in-2021). And despite social media’s potential to serve as a connecting force it’s become increasingly apparent that usage can also increase [“dissatisfaction, jealousy, negative body image and loneliness.](https://doi.org/10.2307/j.ctt1g69z35.20)”
...
## We used data from the [American Time Use Survey](https://www.bls.gov/tus/datafiles_2021.htm) to examine trends in leisure time usage among young adults across different walks of life.
...
1. Screen Time: <span className="text-gray-500">watching movies, watching TV, watching sports</span>
2. Social: <span className="text-gray-500">speaking in person, calling people, going to parties</span>
3. Exercise: <span className="text-gray-500">walking, weightlifting, playing volleyball</span>
4. Creative: <span className="text-gray-500">visiting museums, arts and crafts listening to music</span>
5. Games: <span className="text-gray-500">gambling, playing games</span>

We also broke young adult respondents (who we defined as those between the ages of 18 and 25) into four social groups:

1. Students: <span className="text-gray-500">current students not in the labor force</span>
2. Working Students: <span className="text-gray-500">current students who are also employed</span>
3. Employed: <span className="text-gray-500">employed and not a student</span>
4. Job Seeking/Unemployed: <span className="text-gray-500">without a job, and not a student</span>

## **students: life with a soundtrack**
<span className="text-gray-500">average age: 20.0  | average leisure minutes: 368</span>

*Hover over each section to see details.*
<div className="flex items-center max-w-[92vw] overflow-auto">
<iframe
  title="Student Sunburst"
  src="/images/SP25/LifeSat/student-sunburst.html"
  className="h-[300px] w-[300px] mr-[50px]"
></iframe>
...
<span className="text-gray-500">average age: 21.2 | average leisure minutes: 450</span>
...
<iframe
  ...
  src="/images/SP25/LifeSat/unemployed-sunburst.html"
  className="h-[300px] w-[300px]"
></iframe>
</div>

<ImageLoader
    imagePath="public/images/SP25/LifeSat/unemployed-dumbbell-plot.png"
...
<span className="text-gray-500">average age: 22.0 | average leisure minutes: 291</span>

*Hover over each section to see details.*
<div className="flex items-center max-w-[92vw] overflow-auto">
<iframe
  title="Employed Sunburst"
  src="/images/SP25/LifeSat/employed-sunburst.html"
  className="h-[300px] w-[300px] mr-[50px]"
></iframe>
...
<ImageLoader
    imagePath="public/images/SP25/LifeSat/screen-bar.png"
...
<span className="text-gray-500">average age: 20.8 | average leisure minutes: 296</span>

*Hover over each section to see details.*
<div className="flex items-center max-w-[92vw] overflow-auto">
<iframe
  title="Working Student Sunburst"
  src="/images/SP25/LifeSat/working-student-sunburst.html"
  className="h-[300px] w-[300px] mr-[50px]"
></iframe>
...
<ImageLoader
    imagePath="public/images/SP25/LifeSat/working-student-plot.png"
...
<ImageLoader
    imagePath="public/images/SP25/LifeSat/variable-importance.png"
    alt="Working Student Plot"
/>
