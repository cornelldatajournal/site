...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig1.png" alt="Basic Rubik's Cube - 1"/>

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig2.png" alt="Basic Rubik's Cube - 2"/>

Next, we perform a test on each sample. Three slices happen to test positive.

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig3.png" alt="Basic Rubik's Cube - 3"/>

Finally, with these nine tests, we can tell which sample is positive by seeing where the positive slices overlap.

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig4.png" alt="Basic Rubik's Cube - 4"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig5.png" alt="Basic Rubik's Cube - 5"/>

A cube, which is 3-dimensional, is a combination of 3 planes.

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig6.png" alt="Basic Rubik's Cube - 6"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig7.png" alt="Basic Rubik's Cube - 7"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig8.png" alt="Basic Rubik's Cube - 8"/>

The same thing can be done in the y-axis and z-axis. 

### Y-Axis Cuts

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig9.png" alt="Basic Rubik's Cube - 9"/>

### Z-Axis Cuts

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig10.png" alt="Basic Rubik's Cube - 10"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig11.png" alt="Basic Rubik's Cube - 11"/>

### Y-Axis Cuts

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig12.png" alt="Basic Rubik's Cube - 12"/>

### Z-Axis Cuts

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig13.png" alt="Basic Rubik's Cube - 13"/>

### W-Axis Cuts

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig14.png" alt="Basic Rubik's Cube - 14"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig15.png" alt="Basic Rubik's Cube - 15"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig16.png" alt="Basic Rubik's Cube - 16"/>
...
<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig17.png" alt="Basic Rubik's Cube - 17"/>

In the first round of testing, each hypercube is tested as a whole. On average, 8.35 hypercubes test positive.

<ImageLoader imagePath="public/images/SP20/elegant-geometry/fig18.png" alt="Basic Rubik's Cube - 18"/>
