...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/6.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/4.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/7.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/8.png"
/>
...
This spatial random forest is made of decision trees. Each tree makes a series of if-then decisions to estimate whether the rent is above a certain threshold. This decision tree is then repeated numerous times with different factors considered to form a “forest” of decision trees. Such results from each tree are then averaged to give our predicted fair rent of a listing from the official [Cornell Off-Campus Website](https://listings.offcampusliving.cornell.edu/). We reached out to Cornell Off-Campus Living but did not receive a response.

<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/5.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/10.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/1.png"
/>
...
<ImageLoader
    imagePath="public/images/SP25/IthacaInsights/2.png"
/>
