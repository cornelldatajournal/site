...
Ithaca Insights is an interactive dashboard made through the findings illustrated <a href="https://cornelldatajournal.org/articles/ithaca-insights" style={{color: '#462dbb', textDecoration: 'underline', textDecorationStyle: 'dotted'}}>in this article</a>. The dashboard shows how rental prices across Tompkins County compare to fair market value. It pulls real-time parcel data from Cornell and maps where properties may be over or underpriced based on a range of factors.
