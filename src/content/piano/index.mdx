...
section: "Culture"
image_path: "public/images/SP25/Piano/Thumb.png"
layout: "image"
order: 4
...
<ImageLoader
    imagePath="public/images/SP25/Piano/17.png"
...
At the same time, competitions such as the prestigious International Chopin Competition in Warsaw attract upwards of [600 applicants](https://chopincompetition.pl/en/newsroom/we-know-the-names-of-171-participants-in-the-preliminaries-of-the-19th-chopin-competition?id=21) in 2025 alone.

<ImageLoader
    imagePath="public/images/SP25/Piano/11.png"
...
<ImageLoader
    imagePath="public/images/SP25/Piano/7.png"
    alt="preliminary semifinal final"
/>

<div className="bg-black text-white p-[20px]">

What would it take for *you* to win one of these competitions? Is it enough to just practice for a few hours each for a few years? Probably not. 18-year-old Yunchan Lim, the winner of the 2022 Cliburn International Piano Competition, was practicing around *eight* hours a day once he became a teenager, and had no room for hobbies. He gives [further insight](https://www.gramophone.co.uk/features/article/yunchan-lim-interview-i-decided-that-i-will-give-up-everything-for-music):
...
## <div className="text-white"> Some Notes on Notes</div>
...
<div className="flex justify-center mb-[20px]">
            <iframe
            src="https://www.youtube.com/embed/-_7-Lemqarg"
            title="YouTube Video"></iframe>
</div>
<div className="flex justify-center">
<iframe
            src="https://www.youtube.com/embed/AvJIEsEzmtc"
            title="YouTube Video"></iframe>
</div>
  <div className="text-center">
...
But how do you go from sheet music to data? After compiling a list of all the pieces played in our sample of competitors, we outsourced the first step to the public–that is to say, we searched [musescore.com](https://musescore.com/), an online score-sharing platform, to find digital versions of the sheet music in a manageable file format. These files hold important data points such as notes, timing, dynamics, instruments, and more. Think of them like a *digital version of sheet music* which allows the software to play back the music.
...
## <div className="text-white"> Repertoire Difficulty</div>
...
<ImageLoader
    imagePath="public/images/SP25/Piano/14.png"
    alt="preliminary semifinal final"
/>
...
<ImageLoader
    imagePath="public/images/SP25/Piano/2.png"
    alt="preliminary semifinal final"
/>

<ImageLoader
    imagePath="public/images/SP25/Piano/16.png"
    alt="preliminary semifinal final"
/>

<div className="bg-black text-white p-[20px]">

## <div className="text-white"> Repertoire Selection </div>
...
<ImageLoader
    imagePath="public/images/SP25/Piano/1.png"
    alt="preliminary semifinal final"
/>
...
<ImageLoader
    imagePath="public/images/SP25/Piano/8.png"
    alt="preliminary semifinal final"
/>

<ImageLoader
    imagePath="public/images/SP25/Piano/13.png"
    alt="preliminary semifinal final"
/>

<div className="bg-black text-white p-[20px]">

## <div className="text-white"> Geography </div>
...
<ImageLoader
    imagePath="public/images/SP25/Piano/15.png"
    alt="preliminary semifinal final"
/>

<ImageLoader
    imagePath="public/images/SP25/Piano/10.png"
    alt="preliminary semifinal final"
/>
...
The vast majority of competitors across all competitions are male. But is that because men play better or the jury picks men more often? When looking specifically at the Sydney 2016, Sydney 2021, Kern 2022, Tchaikovsky 2015, Tchaikovsky 2019, and Tchaikovsky 2023, the percentage of women competitors ranged from a mere 8% to 36%. However, this imbalance primarily stems from the relatively **low number of female applicants to piano competitions in general** - for instance, [only 31% of applicants to the Leeds International Piano Competition are female](https://thepianoleague.com/news/opinion/correcting-imbalances-do-equality-measures-undermine-merit-in-piano-competitions/#:~:text=As%20the%20curtains%20fell%20on,were%20compelled%20to%20confront%20this.%E2%80%9D&text=In%2020%20Leeds%20competitions%2C%20only,applications%20come%20from%20female%20pianists). This suggests that juries aren’t necessarily simply biased towards picking male competitors over female competitors. 

<ImageLoader
    imagePath="public/images/SP25/Piano/5.png"
    alt="preliminary semifinal final"
/>

<ImageLoader
    imagePath="public/images/SP25/Piano/6.png"
    alt="preliminary semifinal final"
/>

<div className="bg-black text-white p-[20px]">

## <div className="text-white"> What's Next </div>

Some of the factors we discussed can’t be controlled, such as geography and gender. Other factors, such as repertoire selection and overall proficiency at the instrument are so similar between top performers that differences between ratings at [top competitions can be quite negligible](https://chopin2020.pl/en/news/article/505/18th-chopin-competition---jurors%27-scoring). 

More importantly, losing a competition doesn’t mean your career as a pianist is over! Ivo Pogorelich was famously jousted from the 1980 Chopin Competition for his unorthodox playing, but [Martha Argerich’s resignation from the jury transformed him into a star](https://ivopogorelich.com/chopin-recital/).
...
<ImageLoader
    imagePath="public/images/SP25/Piano/4.png"
    alt="preliminary semifinal final"
/>
<div className="text-center">
